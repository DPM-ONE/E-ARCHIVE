        ...
        try {
            $stmt = $pdo->prepare("
                INSERT INTO agences_dpm
                    (nom_agence, responsable_prenom, responsable_nom, numero_decision, adresse, departement_id,
                     arrondissement_id, district_id, localite, quartier, telephone, email,
...
<head>
    ...
    <title>Ajouter une agence — DPM Archive</title>
...
<header class="topbar">
    ...
    <h1 class="topbar__title">Ajouter une agence pharmaceutique</h1>
...
<div class="form-page">
    ...
    <div class="form-page__header">
        <h2 class="form-page__title">Nouvelle agence pharmaceutique</h2>
        <p class="form-page__sub">Remplissez les informations pour enregistrer une agence</p>
    </div>
            ...
            <div>
                ...
                <div class="form-card">
                    <div class="form-card__header">
                        ...
                        <div>
                            <div class="form-card__title">Identité de l'agence</div>
                    ...
                    <div class="form-card__body">
                        <div class="fields-grid">
                            <div class="field field-full">
                                <label class="field__label required">Nom de l'agence pharmaceutique</label>
                                <input type="text" name="nom_agence"
                                    class="field__input <?= isset($errors['nom_agence']) ? 'error' : '' ?>"
                                    placeholder="Ex : Agence Centrale Brazzaville"
                                    value="<?= htmlspecialchars($old['nom_agence'] ?? '') ?>" required>
                                <?php if (isset($errors['nom_agence'])): ?>
                                    <div class="field__error visible"><?= $errors['nom_agence'] ?></div>
                                <?php endif; ?>
                            </div>
                            <div class="field field-full">
                    ...
                    <div class="form-card__body">
                        <div class="fields-grid fields-grid--2">
                            <div class="field">
                                ...
                                <input type="text" name="responsable_prenom"
                    ...
                    <div class="form-card__body">
                        ...
                        <div class="toggle-group" style="margin-top:16px">
                            <label class="toggle-item">
                                ...
                                <span class="toggle-label">Agence active</span>
                            </label>
                        </div>
                    </div>
                </div>
...
const REQUIRED = ['nom_agence','responsable_prenom','responsable_nom','numero_decision','adresse','localite','departement'];
...
function updateCompletion() {
    ...
    const nom     = document.querySelector('[name=nom_agence]')?.value.trim() || '';
