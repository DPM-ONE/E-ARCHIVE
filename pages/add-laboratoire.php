...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        $stmt = $pdo->prepare("
            INSERT INTO laboratoires_dpm
                (nom_laboratoire, pays, agence_id)
            VALUES
                (:nom, :pays, :agence)
        ");
        $stmt->execute([
...
<head>
    ...
    <title>Nouveau Laboratoire — DPM Archive</title>
...
<div class="page">
    <div class="page-head">
        <div class="page-head__eyebrow">Ajouter</div>
        <h2 class="page-head__title">Nouveau Laboratoire</h2>
    </div>
    ...
    <?php if ($success): ?>
        <div class="alert alert--success">
            ...
            <div>
                <strong>Laboratoire ajouté avec succès</strong>
                <p><a href="laboratoires.php">Retour à la liste</a> ou <a href="add-laboratoire.php">Ajouter un autre</a></p>
            </div>
        </div>
    <?php endif; ?>
